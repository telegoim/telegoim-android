...
void ConnectionsManager::initDatacenters() {
    ...
    if (!testBackend) {
        if (datacenters.find(1) == datacenters.end()) {
            ...
            datacenter->addAddressAndPort("43.143.178.223", 10790, 0, "");
            datacenter->addAddressAndPort("43.143.178.223", 10950, 0, "");
            datacenter->addAddressAndPort("43.143.178.223", 11210, 0, "");
